...
import torch
from annealmola_peft_model_hacked import PeftModel
from transformers import GenerationConfig, LlamaTokenizer, AutoConfig
import sys
from typing import Union
from annealmola_modeling_llama_hacked import LlamaForCausalLM_d
...
def main():
    ...
    parser.add_argument('--lora_target_modules', type=str,
                        default="q_proj,v_proj",   help='lora_target_modules')
