...
##newmodified
from src.annealMoELoRA_lora_hacked import LoraModel
    ...
    **Attributes**:
    ...
    def from_pretrained(
        ...
        **kwargs: Any,
        ...
        """
        from src.annealMoELoRA_mapping_hacked import MODEL_TYPE_TO_PEFT_MODEL_MAPPING, PEFT_TYPE_TO_CONFIG_MAPPING
    ...
    def load_adapter(self, model_id: str, adapter_name: str, is_trainable: bool = False, **kwargs: Any):
        from src.annealMoELoRA_mapping_hacked import PEFT_TYPE_TO_CONFIG_MAPPING
