...
import torch
from src.annealmola_peft_model_hacked import PeftModel
from transformers import GenerationConfig, LlamaTokenizer, AutoConfig
import sys
from typing import Union
from src.annealmola_modeling_llama_hacked import LlamaForCausalLM_d
...
def main():
    ...
    for start_idx in tqdm(range(0, len(data_a), max_batch_size)):
        ...
        # 提取任务的学科subject:
        subject = [str(example["subject"]) for example in batch]
